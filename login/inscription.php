...
<div class="min-h-screen flex flex-col items-center justify-center p-6 bg-[#F8FAFC] py-12">
    ...
    <div class="bg-white w-full max-w-2xl p-10 rounded-[3rem] shadow-2xl border border-gray-100">
        ...
        <form action="../traitement_inscription.php" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="space-y-2">
                    <label class="text-[9px] font-bold text-gray-400 uppercase tracking-widest ml-1">Identifiant / Nom</label>
                ...
                <div class="space-y-2">
                    <label class="text-[9px] font-bold text-gray-400 uppercase tracking-widest ml-1">Email professionnel</label>
                ...
                <div class="space-y-2">
                    <label class="text-[9px] font-bold text-gray-400 uppercase tracking-widest ml-1">Localisation (Annexe)</label>
                    <select name="annexe" class="w-full px-6 py-4 rounded-2xl bg-gray-50 border-transparent focus:bg-white focus:ring-2 focus:ring-sage outline-none text-sm appearance-none cursor-pointer">
                        <option value="" disabled selected>Sélectionnez une annexe</option>
                        <option>Paris 10ème (La Fayette)</option>
            ...
            <div class="pt-4">
                ...
                <p class="text-center mt-6 text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                    Déjà inscrit ? <a href="connexion.php" class="text-sage hover:underline">Se connecter</a>
                </p>
            </div>
        </form>
    </div>
