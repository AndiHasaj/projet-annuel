...
$ca = json_decode(file_get_contents("http://localhost:8080/suivi-financier/chiffre-d-affaires"), true);
$charges = json_decode(file_get_contents("http://localhost:8080/suivi-financier/charges"), true);
$benefice = json_decode(file_get_contents("http://localhost:8080/suivi-financier/benefice"), true);
$taux_benefice = json_decode(file_get_contents("http://localhost:8080/suivi-financier/taux-benefice"), true);
    ...
    <main class="lg:ml-72 p-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div class="bg-white p-8 rounded-ucu border border-gray-100 shadow-sm">
                ...
                <p class="text-3xl font-montserrat font-bold text-ucu-foret"><?= number_format($ca['total'], 2, ',', ' ') ?> €</p>
