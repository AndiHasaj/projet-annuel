...
<div class="min-h-screen flex flex-col items-center justify-center p-6 bg-[#F8FAFC]">
    ...
    <div class="bg-white w-full max-w-md p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 relative overflow-hidden">
        ...
        <div class="flex gap-1 p-1 bg-gray-50 rounded-xl mb-8">
            ...
            <a href="../login/connexion_salarie.php" class="flex-1 text-center py-2 text-[10px] font-semibold uppercase rounded-lg bg-white text-forest shadow-sm">Salarié</a>
        ...
        <form action="../login/traitement_connexion_salarie.php" method="POST" class="space-y-5">
            <div>
