...
<div class="min-h-screen flex flex-col items-center justify-center p-6 bg-[#F8FAFC]">
    ...
    <div class="bg-white w-full max-w-md p-10 rounded-[2.5rem] shadow-2xl border border-gray-100 relative overflow-hidden">
        ...
        <div class="flex gap-1 p-1 bg-gray-50 rounded-xl mb-8">
            ...
            <a href="../login/connexion_admin.php" class="flex-1 text-center py-2 text-[10px] font-semibold uppercase rounded-lg bg-white text-forest shadow-sm">Admin</a>
        </div>

        <form action="../login/traitement_connexion_admin.php" method="POST" class="space-y-5">
            <div>
                <label class="block text-[10px] font-bold text-gray-400 uppercase mb-2 ml-1 tracking-widest">Identifiant</label>
